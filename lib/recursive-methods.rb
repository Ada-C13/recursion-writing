...
# Time complexity: worse case O(n) where n is length of array
# Space complexity: worse case O(n) where n is length of array
...
# Time complexity: O(n) where n i half the size of the string
# Space complexity: O(n) where n i half the size of the string
...
# Time complexity: O(n) where n is the length of the smaller number
# Space complexity: O(n) where n is the length of the smaller number
def digit_match(n, m)
  # raise NotImplementedError, "Method not implemented"
  count = 0
  if n < 10 && m < 10
